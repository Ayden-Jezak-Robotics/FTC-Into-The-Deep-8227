...
public class Constants {
    ...
    public static final double DRIVE_RADIUS = 77.5;
    public static final double STRAFE_RADIUS = 160; //Double check the radii
    ...
    public static final double TURN_TOLERANCE_IN_DEGREES = 2;
